local Statistics = {
    ...
    Text = {
        Left = { X = -40, Y = 10, Scale = 0.35 },
    },
    Bar = { Right = 8, Y = 21, Width = 200, Height = 10, OffsetRatio = 0.5 },
    Divider = {
        [1] = { X = 200, Y = 21, Width = 2, Height = 10 },
        [2] = { X = 200, Y = 21, Width = 2, Height = 10 },
        [3] = { X = 200, Y = 21, Width = 2, Height = 10 },
        [4] = { X = 200, Y = 21, Width = 2, Height = 10 },
        [5] = { X = 200, Y = 21, Width = 2, Height = 10 },
    }
}
...
function RageUI.StatisticPanelAdvanced(Text, Percent, RGBA1, Percent2, RGBA2, RGBA3, Index)
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (Index == nil or (CurrentMenu.Index == Index)) then
            ...
            -- RenderText(Text or "", CurrentMenu.X + Statistics.Text.Left.X + (CurrentMenu.WidthOffset / 2), (RageUI.StatisticPanelCount * 40) + CurrentMenu.Y + Statistics.Text.Left.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 6, Statistics.Text.Left.Scale, 245, 245, 245, 255, 0)
            RenderText(Text or "", CurrentMenu.X + 8.0, (RageUI.StatisticPanelCount * 40) + CurrentMenu.Y + Statistics.Text.Left.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, 0, Statistics.Text.Left.Scale, 245, 245, 245, 255, 0)
