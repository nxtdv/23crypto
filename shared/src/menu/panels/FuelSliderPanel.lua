local Slider = {
	...
	Text = {
		Left = { X = 18, Y = 48, Scale = 0.32 },
		Right = { X = 380, Y = 48, Scale = 0.32 },
		Upper = {X = 230, Y = 48, Scale = 0.32},
	},
	Bar = { X = 25, Y = 86, Width = 250, Height = 16 },
	Slider = { X = 20, Y = 64.5, Width = 35, Height = 9 },
	LeftArrow = { Dictionary = "commonmenu", Texture = "arrowleft", X = 12, Y = 82.5, Width = 25, Height = 25 },
	RightArrow = { Dictionary = "commonmenu", Texture = "arrowright", X = 389, Y = 82.5, Width = 25, Height = 25 },
}

function RageUI.FuelPanel(Value, MinValue, UpperText, MaxValue, Actions, Index)
