...
RageUI.Settings = {
    ...
    Items = {
        Title = {
            ...
            Text = { X = 205, Y = 27, Scale = 2.0 },
        },
        Subtitle = {
            Background = { Width = 431, Height = 37 },
            Text = { X = 8, Y = 7, Scale = 0.25 },
            PreText = { X = 425, Y = 7, Scale = 0.25 },
        },
...
--                 RenderText(CurrentMenu.PageCounterColour .. CurrentMenu.Subtitle, CurrentMenu.X + RageUI.Settings.Items.Subtitle.Text.X, CurrentMenu.Y + RageUI.Settings.Items.Subtitle.Text.Y + RageUI.ItemOffset, 4, RageUI.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUI.Settings.Items.Subtitle.Background.Width + CurrentMenu.WidthOffset)
